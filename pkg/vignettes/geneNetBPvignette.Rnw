...
%HDL example
\subsection{HDL Example}

\subsubsection{Specifying biological information}
...
We will fit a CG-BN to \code{hdl} data using\code{fit.gnbp}. To do this, load the data and discretize phenotypes around median. Since HDL 
