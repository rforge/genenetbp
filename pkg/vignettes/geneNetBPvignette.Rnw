...
\subsection{Plotting Discrete Bayesian Networks}

For discrete bayesian networks, a generic plot method is available for both "gnbp" and "dbn" objects. 
